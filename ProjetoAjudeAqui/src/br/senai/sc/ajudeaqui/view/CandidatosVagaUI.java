...
public class CandidatosVagaUI extends javax.swing.JInternalFrame {
	 ...
	 */
	public CandidatosVagaUI(List<Voluntario> listVoluntarios, Anuncio anuncio) {
	...
	private void initComponents(List<Voluntario> listVoluntarios,
			Anuncio anuncio) {

		panelVoluntario = new javax.swing.JPanel();
		lblTitulo = new javax.swing.JLabel("Candidatos a Vaga "
				+ anuncio.getTitulo());
		...
		// table.setModel(new VoluntarioTableModel(null));
