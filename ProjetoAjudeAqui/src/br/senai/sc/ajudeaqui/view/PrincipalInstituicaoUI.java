...
public class PrincipalInstituicaoUI extends javax.swing.JFrame {
	 ...
	 */
	public PrincipalInstituicaoUI(Instituicao instituicao) {
		initComponents(null);
	}
	...
	private void initComponents(Instituicao instituicao) {
				...
				.addGroup(panelDadosInstituicaoLayout.createSequentialGroup()
					...
					.addGroup(panelDadosInstituicaoLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(panelDadosInstituicaoLayout.createSequentialGroup()
							...
							.addGap(8)
							.addGroup(panelDadosInstituicaoLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(Alignment.TRAILING, panelDadosInstituicaoLayout.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(scrollpaneObservacoes, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 353, GroupLayout.PREFERRED_SIZE))))
		...
		cmbTipoServicoFiltroVoluntarios.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
										...
										.addGroup(
												panelFiltroVoluntariosLayout
														...
														.addComponent(
																...
																Alignment.TRAILING)
														.addComponent(
																cmbTipoServicoFiltroVoluntarios, 0,
																258,
																Short.MAX_VALUE))
										.addGroup(
												panelFiltroVoluntariosLayout
	...
	public void salvarEditarAction(Instituicao instituicao) throws Exception {
		...
		if(instituicao == null) {
			...
			Instituicao inst = new Instituicao(razaoSocial, cnpj, nome, email, telefone, endereco, site, responsavel, observacoes);
